...
import { PaymentComponent } from './modules/payment/payment.component'; // เพิ่มการนำเข้า PaymentComponent
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'payment',
        component: PaymentComponent // เพิ่มเส้นทางไปยัง PaymentComponent
      }
    ]
  }
];
